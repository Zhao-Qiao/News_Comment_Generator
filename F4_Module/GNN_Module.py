...
'''
@Time: 16:57
@FileName: GNN_Module.py
@Author: Zhao Qi-ao
'''
import numpy as np
import torch
import dgl
from F4_Module.Attention import Attention_news
from F4_Module.Sentence_encoder import sentEncoder
from F4_Module.GAT import WSWGAT
from F4_Module.PositionalEmbedding import get_sinusoid_encoding_table
...
class GNN_Module(nn.Module):
    ...
    def __init__(self, hps, embed, entity_news_dict):
        ...
        self.embed_size = hps['word_embed_dim']
        #128
