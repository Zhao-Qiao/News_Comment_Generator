...
'''
@Time: 22:39
@FileName: GRU_EncoderDecoder.py
@Author: Zhao Qi-ao
'''
import random
...
class S2sGRU(nn.Module):
    def __init__(self, vocab, senti_model=None, word_emb_dim=128, nhead=4, pretrained_weight=None,
        ...
        self.for_decoder = gru_decoder(output_size=word_emb_dim, hidden_size=self.model_dim)
        self.back_decoder = gru_decoder(output_size=word_emb_dim, hidden_size=self.model_dim)
        # 输出层
